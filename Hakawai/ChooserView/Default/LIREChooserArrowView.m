...
@interface LIREChooserArrowView ()
@end

@implementation LIREChooserArrowView

+ (instancetype)chooserArrowViewPointingUp:(BOOL)pointingUp {
    LIREChooserArrowView *view = [[[self class] alloc] initWithFrame:CGRectMake(0, 0,
                                                                                ARROW_VIEW_WIDTH,
                                                                                ARROW_VIEW_HEIGHT)
