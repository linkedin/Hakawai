...
- (void)paste:(id)sender {
    if (enableMentionsPluginV2 && [self.copyString length] > 0) {
        ...
        [self.controlFlowPlugin textView:self willPasteTextInRange:self.selectedRange programmatic:YES];
        ...
        [self.controlFlowPlugin textView:self willPasteTextInRange:self.selectedRange programmatic:NO];
        [super paste:sender];
    }
    self.wasPaste = YES;
}
